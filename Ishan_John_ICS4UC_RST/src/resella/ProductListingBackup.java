...
public class ProductListingBackup {
	 ...
	 * @param tags
	 */
	public ProductListingBackup (String imageURL, double price, String orderMethod, String location, String title, String listingURL, int listingType, int marketplace, ArrayList<String> tags) {
